...
const Cuttings_products = db.local.Cuttings_products

const productsQueries = {
    products: async() => {
        const products = await Cuttings_products.findAll({
    ...
    distinctProducts: async() => {
        const distinctProducts = await Cuttings_products.findAll({
